      ...
      <div class="row">
          <div class="large-12 columns">
              ...
              <div class="large-4 columns pull-right">
                 <button class="button btn_upload" id="submit_changes" onclick="return editvideocontributor()" >Submit Changes </button>
              </div>
          </div>
          <div style="clear: both"></div>
      </div> 
      ...
      <form name="edit_video_contributor" id="edit_video_contributor" onsubmit="return editvideocontributor();">
          ...
          <div class="report_item edit_item">
            <div class="row collapse">
              ...
              <div class="large-2 column report_col">
                  <p class="file_keyword"> <?php $keys = explode(",", $contributor_videos[$i]['file_keywords']); 
              ...
              <div class="large-1 column report_col">
                  <span class="question_wrap">
                      ...
                      <span class="question_text">
                         ...
                         Category: <?php echo $contributor_videos[$i]['file_category'] ?> </br>
                         Image Type: <?php echo  $contributor_videos[$i]['file_type'] ?> </br>
                         Image Subtype: <?php echo  $contributor_videos[$i]['file_subtype'] ?> </br>
                         Orientation: <?php echo $contributor_videos[$i]['file_orentiation'] ?> </br>
                         People: <?php echo $contributor_videos[$i]['file_people'] ?> </br>
                         Model Notification: <?php 
                                    for($m = 0 ; $m < count($edit_contributor_videos[$i]['models']); $m++){
                                          $email = $edit_contributor_videos[$i]['models'][$m]['model_email'];
                                          if(strlen($email)> 0){
                                              echo $email.'<br/>';
                                          }
                                    }              
                                    ; ?> </br>
                        Release: <?php 
                                for($m = 0 ; $m < count($edit_contributor_videos[$i]['releases']); $m++){
                                      $release = $edit_contributor_videos[$i]['releases'][$m]['release_name'];
                                      $release_url = $edit_contributor_videos[$i]['releases'][$m]['release_url'];
                                      if(strlen($release)> 0){
