...
<script type="text/javascript">
  function applytitleall(){
    $( "input[name='file_name']" ).val($( "input[name='all_title']" ).val());
    return false;
  }
  function applykeywordall(){
    $( "textarea[name='file_keywords']" ).text($( "textarea[name='all_keyword']" ).val());
    return false; 
  }
  function applypriceall(){
    $( "input[name='file_price_large']" ).val($( "input[name='all_price']" ).val());
    return false; 
  }
  function applycategoryall(){
   $("select[name='file_category']" ).val($("select[name='all_category']").val()).change();
   var value = $("select[name='all_category']").val();
   $("select[name='file_category'] option[value='"+value+"']").attr('selected', 'selected');
   $("select[name='file_category'] option[value='"+value+"']").prop('selected', 'selected');
   return false;  
  }
  function applyimagetypeall(){
   $("select[name='file_type']" ).val($("select[name='all_image_type']").val()).change();
   return false;  
  }
  function applyimagesubtypeall(){
   $("select[name='file_subtype']" ).val($("select[name='all_image_subtype']").val()).change();
   return false;  
  }
  function applyorientationeall(){
   $("select[name='file_orientation']" ).val($("select[name='all_orientation']").val()).change();
   return false;  
  }
  function applypeopleall(){
   $("select[name='file_people']" ).val($("select[name='all_people']").val()).change();
   return false;  
  }
  function add_model(){
    $.ajax({
  ...
  function edit_image_contributor(){
