...
<div class="row">
    <div class="large-6 columns medium-6 columns">
        <img src="<?php echo $all_results[$i]['same_shoots'][$s]['file_thumbnail'] ?>" class="search_display_img">
        <div class="similar_links pull-right">
          <a download="<?php echo "suraimages_".$all_results[$i]['same_shoots'][$s]['upload_id']." sample".$all_results[$i]['same_shoots'][$s]['file_name'] ?>" href="<?php echo $all_results[$i]['same_shoots'][$s]['file_thumbnail'] ?>"
        ...
        <div class="search_popup_details">
           ...
           <div class="row collapse">
            ...
            <div class="search_popup_content"> <?php echo $all_results[$i]['same_shoots'][$s]['file_name'] ?></div>
          </div>
          <div class="row collapse">
            <div class="search_popup_title">Image ID 
              <span class="pull-right">:</span>
            </div>
            <div class="search_popup_content"> <?php echo "suraimages_".$all_results[$i]['same_shoots'][$s]['upload_id'] ?></span>
            </div>
          </div>
          <div class="row collapse">
            ...
            <div class="search_popup_content">
                <?php if(count($all_results[$i]['same_shoots'][$s]['releases']) > 0) { ?>
                        Yes
                <?php }  else { ?>
                        No
                <?php } ?>
                 ...
                 <div>
                     <ul class="tabs" data-tabs id="example-tabs">
                       <span class="">
                           ...
                           <?php echo "#panel1".trim($all_results[$i]['same_shoots'][$s]['upload_id'])?>" aria-selected="true">Standard License</a></li>
                           <li class="tabs-title"><a href="
                           <?php echo "#panel2".trim($all_results[$i]['same_shoots'][$s]['upload_id'])?>">Exclusive License</a></li>
                       </span>
                     </ul>

                     <div class="tabs-content" data-tabs-content="example-tabs">
                       <div class="tabs-panel is-active" id="panel1<?php echo trim($all_results[$i]['same_shoots'][$s]['upload_id'])?>">
                           <hr style="border-top: solid 1px;" />
                           <div class="row">
                               <div class="quality_column">
                                 <input type="radio" name="quality" value="
                                    ...
                                    ($all_results[$i]['same_shoots'][$s]['file_price_large']/3), 2, '.', '');
                                    ?>"> Small
                               </div>
                               <div class="desc_column">
                                  ...
                                  <span class="file_s_size"> 
                                    <?php echo ($all_results[$i]['same_shoots'][$s]['file_size']/3)?>
                                  </span>
                                   </p>
                               </div>
                           ...
                           <div class="row">
                               <div class="quality_column">
                                 <input type="radio" name="quality" value="<?php 
                                  echo number_format((float)
                                    ($all_results[$i]['same_shoots'][$s]['file_price_large']/2), 2, '.', '');
                                  ?>"> Medium
                               </div>
                               <div class="desc_column">
                                  <span class="file_dimensions">
                                    <?php
                                      ...
                                      echo round(($all_results[$i]['same_shoots'][$s]['file_width']/2),0).' x '.round(($all_results[$i]['same_shoots'][$s]['file_height']/2),0).'px';
                                    ?>
                                    |
                                  </span>
                                  <span class="file_m_size"> 
                                    <?php echo ($all_results[$i]['same_shoots'][$s]['file_size']/2)?>
                                  </span>
                                  </p>
                               </div>
                               <div class="price_column">
                           ...
                           <div class="row">
                               <div class="quality_column">
                                 <input type="radio" name="quality" value="<?php 
                                    echo number_format((float)
                                    ($all_results[$i]['same_shoots'][$s]['file_price_large']), 2, '.', '');
                                    ?>"> Large
                               </div>
                               <div class="desc_column">
                                 <p>
                                  <span class="file_dimensions">
                                    <?php
                                      echo $all_results[$i]['same_shoots'][$s]['file_width'].' x '.$all_results[$i]['same_shoots'][$s]['file_height'].'px';
                                    ?>
                                    |
                                  </span>
                                  <span class="file_l_size"> 
                                    <?php echo $all_results[$i]['same_shoots'][$s]['file_size']?>
                                  </span>
                                 </p>
                               </div>
                               <div class="price_column">
                       ...
                       <div class="tabs-panel" id="panel2<?php echo trim($all_results[$i]['same_shoots'][$s]['upload_id'])?>">
...
<div class="row">
    <?php 
    if(is_array($all_results[$i]['same_shoots'][$s]['same_shoots'])){ ?>
    <div class="similar_links color-white">
      Same Shoot | <a href="<?php echo base_url('index.php/main/shoot/'.$all_results[$i]['same_shoots'][$s]['file_same_shoot_code']); ?>" target="_blank"> View All </a> 
    </div>
    <div class="large-12 columns pop-similar-images">
        <?php for($s=0; $s < count($all_results[$i]['same_shoots'][$s]['same_shoots']); $s++ ){ ?>
        <div class="large-2 columns">
          
          <div class="search_results_img">
            <a href="<?php echo base_url('index.php/main/details/'.$all_results[$i]['same_shoots'][$s]['same_shoots'][$s]['upload_id']); ?>" class="search_img">
               <img src="<?php echo $all_results[$i]['same_shoots'][$s]['same_shoots'][$s]['file_thumbnail'] ?>" class="search_img" onerror="this.style.display='none'">
            </a>
          </div>
        </div>
        <?php } ?>
