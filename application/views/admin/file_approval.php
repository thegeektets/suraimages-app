<div class="tabs-panel is-active" id="nwcontributors">
    ...
    <div class="report_header">
      ...
      <form  name="edit_image_contributor" id="edit_image_contributor" onsubmit="return editimageadmin();">
       <div class="edit_content">
          <?php for($i=0; $i< count($all_contributor_images); $i++) { ?>
            <?php if( ($all_contributor_images[$i]['user_id'] == $user_session['approval_file'])
                       && ($all_contributor_images[$i]['file_status'] == "0")) { ?>
            <div class="edit_item">
              <div class="row">
                ...
                <div class="large-4 column">
                        <div>Image ID : <?php echo $all_contributor_images[$i]['upload_id']; ?>
                         <input type="hidden" name="file_id[]" class="file_id" value="<?php echo $all_contributor_images[$i]['upload_id']; ?>">
                         <input type="hidden" name="file_user[]" class="file_user" value="<?php echo $all_contributor_images[$i]['user_id']; ?>">
                         </div>
                        <label>Title : </label>
                ...
                <div class="large-3 columns">
                   <div class="row collapse">
                      <div class="large-5 columns">
                          ...
                          <div class="row collapse">
                              <div class="large-12 columns">
                                    <input type="text" name="file_price_large[]" placeholder="Price" value="<?php echo $all_contributor_images[$i]['file_price_large']?>" class="file_price_large">
                              </div>
                      ...
                      <div class="large-5 columns">
                          ...
                          <select name="file_license[]" required="true">
                              <option value="">Select License</option>
                              <option value="Royalty Free"> Royalty Free 
                              </option>
                ...
                <div class="large-3 columns">
                      ...
                      <div class="approve">
                        ...
                        <input type="hidden" name="file_status[]" class="file_status" value="<?php echo $all_contributor_images[$i]['file_status']; ?>">
                      </div>
                </div>
               </div>
            </div>
