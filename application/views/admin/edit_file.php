  ...
  <div class="inside_body">
       ...
       <div class="row">
            ...
            <div class="tabs-panel is-active admin_panel" id="contributors">
                <ul class="tabs inner_admin_tabs" data-tabs id="contributor-tabs">
                    <li class="tabs-title"><a href="#nwcontributors" aria-selected="true"> New Contributors (3) </a></li>
                    <li class="tabs-title"><a href="#excontributors" aria-selected="true"> Existing Contributors
                    (9) </a></li>
                    <li class="tabs-title is-active"><a href="#tluploads" aria-selected="true"> Total Uploads(750)</a></li>
                ...
                <div class="tabs-content" data-tabs-content="contributor-tabs">
                    <div class="tabs-panel" id="nwcontributors">
                        <div class="row">
                                ...
                                <div class="report_content">
                                    ...
                                    <div class="large-7 columns">
                                        ...
                                        <div class="large-12 columns">
                                          <strong>Image ID: </strong> 0012354
                                        </div>
                                        <div class="large-12 columns">
                                          <strong>Photographer: </strong> George Ngechu
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="large-9 columns">
                                                <div class="row collapse">
                                                    ...
                                                    <div class="large-4 columns">
                                                          <input type="text" name="" placeholder="Price" class="form_group" disabled="">
                                                    </div>
                                                    <div class="large-4 columns">
                                                          <input type="text" name="" placeholder="Price" class="form_group" disabled="">
                                                    </div>
                                                ...
                                                <div class="row collapse">
                                                    <div class="large-6 columns">
                                                     <select>
                                                        ...
                                                        <option selected="">Creative</option>
                                                      </select>
                                                    </div>
                                                 </div>       
                                            </div>
                                        ...
                                        <div class="row">
                                          <div class="large-6 columns">
                                              <strong>Attach Release(s): (2) </strong>
                                              <div class="red">Jane Release form.jpg </div>
                                              <div class="red">Jane’s baby girl release form.pdf </div>
                                          </div>
                                          <div class="large-6 columns">
                                              <strong>Model Notification: (1) </strong>
                                              <div class="">jmakali@gmail.com </div>
                                          </div>
                                        </div>
                                        <div class="row">
                                           <strong>Date Uploaded: </strong><span> 23th December, 2015</span>
                                        </div>
                                        <hr style="margin-bottom:15px" />
                                    </div>
                                    <div class="large-3 columns pull-right">
                                      <button class="button postfix">Save Changes</button>   
                                    </div>
                                </div>           
                            </div>                
                        </div>
